...
define config.name = "Doki Doki Waifu Club (beta) (remember to delete this!)"
...
define build.name = "Doki Doki waifu club"
...
#define config.main_menu_music = "Your Reality.wav"
